...
pub struct Condition {
    /// Specifies which alert field will be used in condition. Possible values are message, alias, description, source, entity, tags, actions, extra-properties, recipients, responders or teams
    #[serde(rename = "field")]
    pub field: FieldEm,
...
impl Condition {
    pub fn new(field: FieldEm, operation: OperationEm) -> Condition {
        Condition {
            field,
            key: None,
            not: None,
