...
pub struct CreateScheduleRotationPayload {
    /// Name of rotation
    ...
    pub participants: Vec<crate::models::Recipient>,
...
impl CreateScheduleRotationPayload {
    pub fn new(start_date: String, _type: TypeEm, participants: Vec<crate::models::Recipient>) -> CreateScheduleRotationPayload {
