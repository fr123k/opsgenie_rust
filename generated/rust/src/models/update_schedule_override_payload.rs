...
pub struct UpdateScheduleOverridePayload {
    #[serde(rename = "user")]
...
impl UpdateScheduleOverridePayload {
    pub fn new(user: crate::models::Recipient, start_date: String, end_date: String) -> UpdateScheduleOverridePayload {
